        ...
        executeButton.addActionListener(e -> {
            ...
            try {
                ...
                try {
                    ...
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (1, 1, UTL_RAW.CAST_TO_RAW('Alice Bob'), TO_DATE('2002-04-13', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (2, 2, UTL_RAW.CAST_TO_RAW('Jake Blake Resume'), TO_DATE('2025-09-28', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (3, 3, UTL_RAW.CAST_TO_RAW('Griffin Walker Resume'), TO_DATE('2025-09-29', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (4, 4, UTL_RAW.CAST_TO_RAW('Ed Stephens Resume'), TO_DATE('2025-09-28', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (5, 5, UTL_RAW.CAST_TO_RAW('Joe Random Resume'), TO_DATE('2025-09-29', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (6, 6, UTL_RAW.CAST_TO_RAW('Michael Jordan Resume'), TO_DATE('2025-09-30', 'YYYY-MM-DD'))");
                    dbConnection.executeUpdate("INSERT INTO Resume (resumeID, applicantID, upload_file, uploadDate) VALUES (7, 6, UTL_RAW.CAST_TO_RAW('Michael Jordan Resume 2'), TO_DATE('2025-10-04', 'YYYY-MM-DD'))");
                    ...
                    dbConnection.executeUpdate("UPDATE Resume SET upload_file = UTL_RAW.CAST_TO_RAW('Alice Bob Resume') WHERE resumeID = 1");

                    connection.commit(); 
                    JOptionPane.showMessageDialog(this, "Tables populated successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                ...
                errors.append("Database connection error: ").append(ex.getMessage()).append("\n");
            }
        });
